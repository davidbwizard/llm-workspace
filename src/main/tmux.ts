 ...
 *  key send chooses between. Do not pre-populate Escape/Up/Down/C-c ahead
 *  of a real need. */
...
const ALLOWED_KEY_NAMES: readonly string[] = ['Enter', 'Tab'] as const satisfies readonly KeyName[];
